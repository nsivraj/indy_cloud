...
public class WriteSchemaAndCredDef {
	...
	static void demo() throws Exception {
		...
		AnoncredsResults.IssuerCreateAndStoreCredentialDefResult createCredentialDefResult = issuerCreateAndStoreCredentialDef(walletHandle, trustAnchorDID, schemaJson, "tag1", null, Const.DEFAULT_REVOCATION_CONFIG).get();
